#include<moying_mcr_arm_dynamics_models/elfin/elfin10l_pose1_dynamics_model.h>
...
void Elfin10lPose1DynamicsModel::tau( double* tau_out, const double* parms, const double* q, const double* dq, const double* ddq )
{
  double x0 = cos(q[1]);
  double x1 = -dq[1];
  double x2 = sin(q[1]);
  ...
  double x45 = x11*x17;
  double x46 = x13*x21 - 0.52*x39 - 0.52*x40 + x43*x45;
  double x47 = -0.48*ddq[1] + 9.788*x2;
  double x48 = 9.788*x0;
  double x49 = x11*x23;
  double x50 = x17*x47 + x28*x48 + x30*x49;
  double x51 = -0.52*x25;
  double x52 = x12*x25 + x19*x46 + x21*x50 + x31*x51 + 0.52*x42;
  double x53 = sin(q[4]);
  double x54 = cos(q[4]);
  double x55 = -x54;
  double x56 = -x29;
  ...
  double x65 = -x64;
  double x66 = x13*x25 + x21*x45 + 0.52*x22 - 0.52*x26;
  double x67 = -x49;
  ...
  double x89 = dq[5] + x58;
  double x90 = x46*x73 + x68*x82 - 0.2*x83 - 0.2*x84;
  double x91 = x46*x75 + x68*x73 + 0.2*x77 - 0.2*x78;
  double x92 = -parms[72];
  ...
  double x97 = x12*x21 + x18*x66 - 0.52*x32 - 0.52*x34 + x43*x50;
  double x98 = x52*x54 + x53*x65 + x59*x94;
  double x99 = x73*x97 - 0.2*x74 - 0.2*x76 + x82*x98 + x86*x91;
  ...
  double x111 = -0.2*x75;
  double x112 = dq[5]*x90 + x111*x60 + x73*x98 + x75*x97 + 0.2*x81;
  ...
  double x120 = parms[52]*x60 + parms[53]*x61 + parms[54]*x63 + parms[59]*x69 + x104*x73 + x106*x46 + x107*x97 + x108*x109 - x110*x94 + x111*x117 + x116*x82 - 0.2*x119 + x70*x72;
  ...
  double x157 = parms[53]*x60 + parms[55]*x61 + parms[56]*x63 + parms[60]*x98 + x104*x75 + x105*x69 - x106*x68 + x111*x118 + x116*x73 + x128*x58 + x130*x94 + x155*x72 + 0.2*x156;
  double x158 = -x124;
  ...
  double x165 = parms[26]*x31 + parms[27]*x33 + parms[28]*x36 + parms[33]*x64 + x12*x138 + x13*x154 + x137*x56 + x139*x67 + x149*x20 + x153*x21 + x159*x43 + x162*x51 - 0.52*x164;
  ...
  double x172 = parms[27]*x31 + parms[29]*x33 + parms[30]*x36 + parms[32]*x65 + parms[34]*x50 + x140*x29 + x142*x49 + x148*x154 + x149*x169 + x153*x25 + x159*x21 + x163*x51 + 0.52*x171;
//
  ...
  tau_out[1] = ddq[1]*parms[23] + dq[1]*parms[24] - parms[15]*x4 - parms[17]*x8 - parms[18]*x9 - parms[19]*x47 - 0.48*parms[19]*x9 + parms[20]*x48 - 0.48*parms[22]*x47 + parms[25]*(((dq[1]) > 0) - ((dq[1]) < 0)) - 0.48*x1*x168 - x11*x170 - 0.48*x145*x4 - x146*x6 - 0.48*x15*x7 + x167*x3 - 0.48*x17*(parms[33]*x37 + parms[34]*x33 + parms[35]*x50 + x139*x56 + x154*x20 + x163*x43 + x171) - x172 - 0.48*x23*(-parms[32]*x33 + parms[33]*x31 + parms[35]*x64 - parms[45]*x44 - parms[48]*x65 - x121*x35 - x124*x27 - x134*x135 + x139*x24 + x141*x142 - x160*x53 - x161*x55);
