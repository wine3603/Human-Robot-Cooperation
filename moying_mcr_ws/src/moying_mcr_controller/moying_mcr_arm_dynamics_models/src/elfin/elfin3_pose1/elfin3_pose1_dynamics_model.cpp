...
Elfin3Pose1DynamicsModel::Elfin3Pose1DynamicsModel() : robot_dof_(6), params_total_amount_(78),
...
Elfin3Pose1DynamicsModel::~Elfin3Pose1DynamicsModel()
{

}

int Elfin3Pose1DynamicsModel::get_robot_dof()
{
  return robot_dof_;
}

int Elfin3Pose1DynamicsModel::get_params_total_amount()
{
  return params_total_amount_;
}

int Elfin3Pose1DynamicsModel::get_basic_params_amount()
{
  return basic_params_amount_;
}

std::vector<size_t> Elfin3Pose1DynamicsModel::get_basic_params_index()
{
  return basic_params_index_;
}

int Elfin3Pose1DynamicsModel::get_gravity_basic_params_amount()
{
  return gravity_basic_params_amount_;
}

std::vector<size_t> Elfin3Pose1DynamicsModel::get_gravity_basic_params_index()
{
  return gravity_basic_params_index_;
}

std::vector<size_t> Elfin3Pose1DynamicsModel::get_coulomb_friction_params_index()
{
  return coulomb_friction_params_index_;
}

std::vector<size_t> Elfin3Pose1DynamicsModel::get_viscous_friction_params_index()
{
  return viscous_friction_params_index_;
}

std::vector<double> Elfin3Pose1DynamicsModel::get_gravity_vector()
{
