#include<moying_mcr_arm_dynamics_models/elfin/elfin3_pose2_dynamics_model.h>
...
void Elfin3Pose2DynamicsModel::inertiaMatrixB( double* b_out, const double* parms, const double* q )
{
  double x0 = cos(q[1]);
  double x1 = sin(q[1]);
  double x2 = x1*(-0.266*((x0)*(x0)) - 0.266*((x1)*(x1)));
  double x3 = sin(q[2]);
  double x4 = -x3;
  double x5 = cos(q[2]);
  ...
  double x27 = x17*x22;
  double x28 = x26 - x27;
  double x29 = x2*x7 - 0.324*x8;
  double x30 = x14*x15;
  double x31 = -x22;
  double x32 = x21*x29 - 0.1975*x23 - 0.1975*x24 + x30*x31;
  double x33 = -parms[73];
  double x34 = parms[65]*x25 + parms[66]*x28 + parms[67]*x19 + parms[72]*x20 + x32*x33;
  double x35 = -parms[60];
  double x36 = x21*x30 + x22*x29 + 0.1975*x26 - 0.1975*x27;
  double x37 = -parms[71];
  double x38 = parms[66]*x25 + parms[68]*x28 + parms[69]*x19 + parms[73]*x36 + x20*x37;
  double x39 = -0.1975*x22;
  double x40 = -parms[72];
  double x41 = parms[73]*x28 + parms[74]*x36 + x19*x40;
  double x42 = parms[71]*x19 + parms[74]*x32 + x25*x33;
  double x43 = x21*x42;
  double x44 = parms[52]*x17 + parms[53]*x13 + parms[54]*x19 + parms[59]*x20 + x21*x34 + x29*x35 + x31*x38 + x39*x41 - 0.1975*x43;
  double x45 = -parms[45];
  double x46 = -parms[59];
  ...
  double x53 = -parms[58];
  double x54 = x21*x41;
  double x55 = parms[53]*x17 + parms[55]*x13 + parms[56]*x19 + parms[60]*x30 + x20*x53 + x21*x38 + x22*x34 + x39*x42 + 0.1975*x54;
  double x56 = -parms[46];
  ...
  double x62 = -0.324*x11;
  double x63 = parms[46]*x8 + parms[48]*x29 + parms[58]*x19 + parms[61]*x29 + x10*x45 + x17*x35 + x22*x41 + x43;
  double x64 = x63*x7;
  double x65 = parms[26]*x6 + parms[28]*x9 + x2*x52 + x51*x7 + x57*x58 + x61*x62 - 0.324*x64;
  double x66 = -parms[19];
  double x67 = x61*x7;
  double x68 = parms[27]*x6 + parms[30]*x9 + x11*x51 + x57*x7 + x62*x63 + 0.324*x67;
  double x69 = -parms[47];
  double x70 = -parms[15]*x0 - parms[17]*x1 + 0.266*parms[21]*x0 - 0.266*x3*(parms[33]*x6 - parms[45]*x13 - x16*x59 - x18*x60 - x69*x8) - 0.266*x5*(parms[33]*x10 + x58*x63 + x67) - x68;
  double x71 = -0.266*x5;
  double x72 = -x7;
  double x73 = 0.324*x11 + x58*x71;
  double x74 = x15*x58;
  double x75 = x16*x58;
  double x76 = x7*x71 - 0.324*x7;
  double x77 = -0.266*x3;
  double x78 = -x77;
  ...
  double x85 = x21*x73 + x31*x84 + x39*x72 - 0.1975*x80;
  double x86 = parms[65]*x81 + parms[66]*x83 + parms[67]*x75 + parms[72]*x79 + x33*x85;
  double x87 = x21*x84 + x22*x73 + x39*x74 + 0.1975*x82;
  ...
  double x91 = x21*x90;
  double x92 = parms[52]*x74 + parms[53]*x72 + parms[54]*x75 + parms[59]*x79 + x21*x86 + x31*x88 + x35*x73 + x39*x89 - 0.1975*x91;
  ...
  double x95 = x21*x89;
  double x96 = parms[53]*x74 + parms[55]*x72 + parms[56]*x75 + parms[60]*x84 + x21*x88 + x22*x86 + x39*x90 + x53*x79 + 0.1975*x95;
  ...
  double x101 = -parms[29] + parms[32]*x78 + parms[34]*x71 + x100*x62 + x11*(parms[39]*x58 + parms[41]*x72 + parms[46]*x73 + x15*x92 + x16*x94 + x69*x78) + x7*(parms[41]*x58 + parms[44]*x72 + parms[45]*x78 + x56*x76 + x96) + 0.324*x99;
  double x102 = -parms[40]*x58 - parms[43]*x72 - parms[47]*x76 - x16*x92 - x18*x94 - x45*x73;
  double x103 = x11*x15;
  double x104 = x11*x16;
  double x105 = 0.324*x7;
  ...
  double x112 = -0.1975*x107 + x111*x31 + x21*x62 + x39*x7;
  double x113 = parms[65]*x108 + parms[66]*x110 + parms[67]*x104 + parms[72]*x106 + x112*x33;
  double x114 = x103*x39 + 0.1975*x109 + x111*x21 + x22*x62;
  ...
  double x119 = parms[52]*x103 + parms[53]*x7 + parms[54]*x104 + parms[59]*x106 + x113*x21 + x115*x31 + x116*x39 - 0.1975*x118 + x35*x62;
  ...
  double x123 = parms[53]*x103 + parms[55]*x7 + parms[56]*x104 + parms[60]*x111 + x106*x53 + x113*x22 + x115*x21 + x117*x39 + 0.1975*x122;
  double x124 = -parms[40]*x11 - parms[43]*x7 - parms[47]*x105 - x119*x16 - x121*x18 - x45*x62;
  double x125 = -x16;
  double x126 = x125*x21;
  double x127 = x125*x31;
  double x128 = -0.1975*x126;
  ...
  double x135 = parms[53]*x125 + parms[56]*x15 + x129*x22 + x131*x21 + 0.1975*x132*x21 + x133*x39;
  double x136 = 0.1975*x21;
...
//
  ...
  b_out[5] = x47;
  b_out[6] = x70;
  b_out[7] = parms[18] + 0.266*parms[19] + 0.070756*parms[22] + parms[23] - x101 - 0.266*x3*(parms[32] + parms[35]*x77 - parms[45]*x72 - parms[48]*x78 - x16*x97 - x18*x98 - x58*x69) - 0.266*x5*(parms[35]*x71 + x100*x58 + x52 + x99) - 0.266*x66;
  b_out[8] = x101;
  b_out[9] = x102;
  b_out[10] = x96;
  b_out[11] = x93;
  ...
  b_out[19] = x102;
  b_out[20] = x124;
  b_out[21] = parms[42] + parms[49] - x16*(parms[52]*x125 + parms[54]*x15 + x129*x21 + x131*x31 + x132*x39 - 0.1975*x133*x21) - x18*(parms[54]*x125 + parms[57]*x15 + x134);
  b_out[22] = x135;
  b_out[23] = x134;
  b_out[24] = x55;
  b_out[25] = x96;
