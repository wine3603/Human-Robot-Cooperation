...
void Elfin3Pose2DynamicsModel::coriolisTerm( double* c_out, const double* parms, const double* q, const double* dq )
{
  double x0 = cos(q[1]);
  double x1 = -dq[1];
  double x2 = sin(q[1]);
  ...
  double x39 = x16*x8;
  double x40 = x19*x39;
  double x41 = -0.324*x26;
  double x42 = x15*x8;
  double x43 = x11*x21 + x34*x42 - 0.324*x35 - 0.324*x36;
  ...
  double x55 = dq[2]*x42;
  double x56 = -x55;
  double x57 = x11*x26 + x21*x42 + 0.324*x24 - 0.324*x27;
  double x58 = -x39;
  ...
  double x79 = dq[5] + x51;
  double x80 = x43*x64 + x59*x73 - 0.1975*x74 - 0.1975*x75;
  double x81 = x43*x66 + x59*x64 + 0.1975*x68 - 0.1975*x69;
  double x82 = -parms[72];
  ...
  double x87 = x21*x9 - 0.324*x22 + x29*x57 + x34*x40;
  double x88 = x44*x46 + x45*x56 + x47*x84;
  double x89 = x64*x87 - 0.1975*x65 - 0.1975*x67 + x73*x88 + x77*x81;
  double x90 = -parms[73];
  ...
  double x98 = -parms[60];
  double x99 = -0.1975*x66;
  double x100 = dq[5]*x80 + x52*x99 + x64*x88 + x66*x87 + 0.1975*x72;
  ...
  double x111 = parms[52]*x52 + parms[53]*x38 + parms[54]*x54 + parms[59]*x60 + x104*x73 + x105*x106 + x107*x94 + x108*x99 - 0.1975*x110 + x43*x97 + x61*x63 + x64*x95 + x87*x98;
  ...
  double x147 = parms[53]*x52 + parms[55]*x38 + parms[56]*x54 + parms[60]*x88 + x104*x64 + x109*x99 + x119*x51 + x121*x84 + x145*x63 + 0.1975*x146 - x59*x97 + x60*x96 + x66*x95;
  double x148 = -x115;
  ...
  double x155 = parms[26]*x20 + parms[28]*x32 + parms[33]*x55 + x11*x144 + x128*x48 + x129*x9 + x130*x58 + x139*x23 + x143*x21 + x149*x34 + x152*x41 - 0.324*x154;
  ...
  double x163 = parms[27]*x20 + parms[30]*x32 + parms[32]*x56 + parms[34]*x40 + x131*x18 + x133*x39 + x138*x144 + x139*x160 + x143*x26 + x149*x21 + x153*x41 + 0.324*x162;
//
  ...
  c_out[1] = -parms[15]*x4 - parms[17]*x7 + 0.266*parms[21]*x4 - 0.266*x1*x159 - 0.266*x13*x6 - x136*x5 - 0.266*x15*(parms[33]*x33 + parms[35]*x40 + x130*x48 + x144*x23 + x153*x34 + x162) - x157*x159 - x158*x161 - 0.266*x16*(parms[33]*x20 + parms[35]*x55 - parms[45]*x38 - parms[48]*x56 - x112*x31 - x115*x28 - x125*x126 + x130*x25 + x132*x133 - x150*x45 - x151*x50) - x163;
  c_out[2] = x163;
  c_out[3] = x127;
  c_out[4] = x147;
  c_out[5] = x118;
