...
typedef struct{
  elfin_ethercat_driver_zombie::ElfinEtherCATClient* client_ptr;
  AxisInfo axis1;
  AxisInfo axis2;
}ModuleInfo;
...
{
public:
  ArmEthercatDriver(std::shared_ptr<elfin_ethercat_driver_zombie::EtherCatManager> ecat_manager,
  ...
  elfin_ethercat_driver_zombie::EtherCatManager* em;
  std::vector<elfin_ethercat_driver_zombie::ElfinEtherCATDriver*> ethercat_drivers_;
