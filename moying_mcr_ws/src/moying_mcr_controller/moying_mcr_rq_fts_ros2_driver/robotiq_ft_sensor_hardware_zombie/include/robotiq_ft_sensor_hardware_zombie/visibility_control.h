...
#ifndef ROBOTIQ_FT_SENSOR_HARDWARE_ZOMBIE__VISIBILITY_CONTROL_H_
#define ROBOTIQ_FT_SENSOR_HARDWARE_ZOMBIE__VISIBILITY_CONTROL_H_
...
#endif  // ROBOTIQ_FT_SENSOR_HARDWARE_ZOMBIE__VISIBILITY_CONTROL_H_
