...
#ifndef MMCO_DUAL_CONTROLLER__MMCO_DUAL_CONTROLLER_HPP_
#define MMCO_DUAL_CONTROLLER__MMCO_DUAL_CONTROLLER_HPP_
...
#include "mmco_dual_controller_parameters.hpp"
#include "mmco_dual_controller/visibility_control.h"
...
#include <mmco_dual_interface/command/mmco_dual_target_trajectories_interactive_marker.h>
...
class MMCODualController : public controller_interface::ControllerInterface
{
public:
  MMCO_DUAL_CONTROLLER__VISIBILITY_PUBLIC
  MMCODualController();
...
protected:
  std::shared_ptr<mmco_dual_controller::ParamListener> param_listener_;
  mmco_dual_controller::Params params_;
...
private:
  ...
  MMCO_DUAL_CONTROLLER__VISIBILITY_LOCAL
  ...
  std::shared_ptr<mmco_dual_interface::MMCODualInterface> mmInterface_;
  ...
  std::shared_ptr<mmco_dual_interface::MMCODualTargetTrajectoriesInteractiveMarker> targetPoseCommandInterface_;
  std::shared_ptr<mmco_dual_interface::MMCODualJoyTargetTrajectories> targetJoyPoseCommandInterface_;
...
#endif  // MMCO_DUAL_CONTROLLER__MMCO_DUAL_CONTROLLER_HPP_
