...
/******************************************************************************************************/
/******************************************************************************************************/
MMCODualTargetTrajectoriesInteractiveMarker::MMCODualTargetTrajectoriesInteractiveMarker(
...
MMCODualTargetTrajectoriesInteractiveMarker::createInteractiveMarker(int mode) const {
...
/******************************************************************************************************/
/******************************************************************************************************/
void MMCODualTargetTrajectoriesInteractiveMarker::leftProcessFeedback(
...
void MMCODualTargetTrajectoriesInteractiveMarker::rightProcessFeedback(
    const visualization_msgs::msg::InteractiveMarkerFeedback::ConstSharedPtr&
        feedback) {
  // Desired state trajectory
  const Eigen::Vector3d position(feedback->pose.position.x,
