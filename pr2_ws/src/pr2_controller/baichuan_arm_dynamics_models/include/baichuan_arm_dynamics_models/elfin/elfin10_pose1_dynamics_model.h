#ifndef BAICHUAN_ARM_ELFIN10_DYN_MODEL_H
#define BAICHUAN_ARM_ELFIN10_DYN_MODEL_H
...
class Elfin10Pose1DynamicsModel : public baichuan::arm::BasicDynamicsModel
{

public:
  Elfin10Pose1DynamicsModel();
  ~Elfin10Pose1DynamicsModel();
