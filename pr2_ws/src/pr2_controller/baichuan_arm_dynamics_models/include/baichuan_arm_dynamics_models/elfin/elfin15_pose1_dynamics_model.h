#ifndef BAICHUAN_ARM_ELFIN15_DYN_MODEL_H
#define BAICHUAN_ARM_ELFIN15_DYN_MODEL_H
...
class Elfin15Pose1DynamicsModel : public baichuan::arm::BasicDynamicsModel
{

public:
  Elfin15Pose1DynamicsModel();
  ~Elfin15Pose1DynamicsModel();
