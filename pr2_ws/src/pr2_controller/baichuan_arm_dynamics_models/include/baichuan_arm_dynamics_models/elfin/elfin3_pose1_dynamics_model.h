#ifndef BAICHUAN_ARM_ELFIN3_DYN_MODEL_H
#define BAICHUAN_ARM_ELFIN3_DYN_MODEL_H
...
class Elfin3Pose1DynamicsModel : public baichuan::arm::BasicDynamicsModel
{

public:
  Elfin3Pose1DynamicsModel();
  ~Elfin3Pose1DynamicsModel();
