#ifndef BAICHUAN_ARM_ELFIN3_P2_DYN_MODEL_H
#define BAICHUAN_ARM_ELFIN3_P2_DYN_MODEL_H

#include <baichuan_arm_dynamics_models/basic_dynamics_model.h>
...
class Elfin3Pose2DynamicsModel : public baichuan::arm::BasicDynamicsModel
{

public:
  Elfin3Pose2DynamicsModel();
  ~Elfin3Pose2DynamicsModel();
...
#endif // end ELFIN3_POSE2_DYNAMICS_MODEL_ELF3_P2_SHENZHEN_DYN_MODEL_H_
