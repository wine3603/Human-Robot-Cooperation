#ifndef BAICHUAN_ARM_ELFIN5_DYN_MODEL_H
#define BAICHUAN_ARM_ELFIN5_DYN_MODEL_H
...
class Elfin5Pose1DynamicsModel : public baichuan::arm::BasicDynamicsModel
{

public:
  Elfin5Pose1DynamicsModel();
  ~Elfin5Pose1DynamicsModel();
