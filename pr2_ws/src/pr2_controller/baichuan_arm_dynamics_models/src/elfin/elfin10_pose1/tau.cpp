#include<baichuan_arm_dynamics_models/elfin/elfin10_pose1_dynamics_model.h>
...
void Elfin10Pose1DynamicsModel::tau( double* tau_out, const double* parms, const double* q, const double* dq, const double* ddq )
{
  double x0 = cos(q[1]);
  double x1 = -dq[1];
  double x2 = sin(q[1]);
