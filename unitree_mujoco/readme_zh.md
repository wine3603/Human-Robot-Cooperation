...
## 消息(DDS idl)类型说明
- Mor，Mcr，Pr2,Unitree Go2, B2, H1, B2w, Go2w 型号的机器人使用 unitree_go idl 实现底层通信
...
#or 
git clone https://github.com/White-Zhao/unitree_sdk2.git   #it includes pr2\mor\mcr
cd unitree_sdk2/
mkdir build
cd build
...
# 机器人仿真仿真场景文件
# 指的是/unitree_robots/pr2/      /unitree_robots/moying/ 文件夹下的 scene.xml 文件,该文件能够自定义是否加载pr2机器人  mcr
